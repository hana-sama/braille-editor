...
The layout mirrors the “print – dots – pattern – Unicode” style, but the cells now contain the **Nemeth‑specific symbols** used for maithematics, science and engineering.
...
1) Multipurpose indicator
2) Expression being modified
3) Directly-over or directly-under indicator (depending on whether the modifier
symbol is printed above or below the expression being modified)
4) Modifier symbol
...
## 11. Greek Letters
The Greek letter indicator is dots 46. All letters in the following table are lowercase (the uppercase print symbols for Delta, Sigma, and Omega are also included in parentheses). To capitalize a letter, add a capital indicator (dot 6) after the Greek
letter indicator.
|Name| Print Symbol| Braille Symbol| Braille Dot Numbers|Unicode|
|---|---|---|---|---|
