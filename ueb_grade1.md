Below is a **Unified English Braille (UEB)** reference table in markdown.  
For each character you’ll see:

| Print | Dots (1‑6) | Braille Pattern | Unicode |
|-------|------------|----------------|---------|

The table is split into four sections for readability.
...
*The letters **K‑Z** are the same dot patterns as **A‑J** with dot 3 added; **W** is the only exception (it comes from the French‑Canadian layout).*

---  

## 2. Numbers (0‑9)

In UEB a **number sign** (⠼, U+283C) precedes the digit.  
The digits themselves reuse the patterns for **A‑J**.
...
## 4. Special Symbols & Common Typographic Marks  
...
* The **Dots** column tells you the physical dot positions (1‑6) for a tactile display or embossing.  
